 ...
 */
public enum WeeblyThemes {
    WEEBLY("weebly", R.style.Theme_Weebly_Demo, R.style.Theme_Weebly_Demo_Dark, R.color.primary, R.color.primary_dark, R.color.accent),
    ...
    WeeblyThemes(String themeName, @StyleRes int theme, @StyleRes int darkTheme, @ColorRes int primaryColor, @ColorRes int darkColor, @ColorRes int accentColor) {
    ...
    public static WeeblyThemes copy(WeeblyThemes theme) {
        WeeblyThemes copy;
    ...
    public static WeeblyThemes getThemeFromString(String themeName) {
        WeeblyThemes theme = GREY;
        ...
        if (ORANGE.themeName.equalsIgnoreCase(themeName)) {
            ...
            theme = BLUE;
        } else if(WEEBLY.themeName.equalsIgnoreCase(themeName)) {
            theme = WEEBLY;
